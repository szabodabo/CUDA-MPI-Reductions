...
public:
	...
	void setNeighborhood(int n) {m_neighborhood = n; computeSegmentationFromTrimap();};

	const unsigned char* getAlpha() const {return d_alpha[current_alpha];}
	int getAlphaPitch() const {return (int)alpha_pitch;};
