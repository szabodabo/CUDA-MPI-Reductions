...
// SDK information
static const char *shrLogFile = "randomFog.txt";
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        if (cutCheckCmdLineFlag(argc, (const char**)argv, "qatest"))
        {
            ...
            // In QA mode, select CUDA device without OpenGL interoperability
